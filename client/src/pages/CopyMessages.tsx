...
// const SentChatItem: React.FC<{
//   item: chatType;
//   handleChatClick: () => void;
// }> = ({ item, handleChatClick }) => {
//   return (
//     <Flex
//       key={item._id}
//       borderWidth="1px"
...
//         <Image src={item.productImage} boxSize="70px" objectFit="cover" />
...
//             <Text>{truncateString(item.conversation[0].message)}</Text>
//           </Flex>
//         </Flex>
//       </Flex>
//     </Flex>
...
// const ReceivedChatItem: React.FC<{ chat: chatType }> = ({ chat }) => {
//   return (
//     <Flex
//       key={item._id}
//       borderWidth="1px"
